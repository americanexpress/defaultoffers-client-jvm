...
import static com.americanexpress.sdk.service.constants.DefaultOffersExceptionConstants.OFFERS_REQUEST_VALIDATION_ERROR;
...
public class AuthenticationServiceImpl implements AuthenticationService {
	...
	public AccessTokenResponse getAccessToken() throws DefaultOffersException {
		...
		if (StringUtils.isEmpty(config.getApiKey()) && StringUtils.isEmpty(config.getApiSecret())) {
			throw new DefaultOffersRequestValidationError(OFFERS_REQUEST_VALIDATION_ERROR);
		}
